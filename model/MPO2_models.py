...
class TR:
    ...
    Same structure as MPO2 but with a periodic boundary condition: an extra
    bond b{L-1} connects the last site back to the first, so every core is
    rank-3 (b{i-1 mod L}, x{i}, b{i mod L}) with an optional output leg.
    """
